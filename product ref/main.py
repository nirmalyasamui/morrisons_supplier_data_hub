...
from productreferenceservicehandle import ProductreferenceServiceHandle as handle
import json
...
def service(request):
    ...
    logging.info("Execution Started fromm mains now")
    ...
    if method in (constant.HTTP_GET, constant.HTTP_POST, constant.HTTP_DELETE):
        ...
        elif json_result[constant.MESSAGE] in [constant.ERROR_NO_VENDOR_SPECIFIED,constant.ERROR_NO_ITEMNO_SPECIFIED,constant.ERROR_NO_USERID_SPECIFIED]:
